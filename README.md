...
* Afterwards go to the [Github tags page](https://github.com/centic9/poi-mail-merge/tags) and
  create a release and add release-notes for the published version
* The resulting binaries should appear at https://repo1.maven.org/maven2/org/dstadler/poi-mail-merge/
